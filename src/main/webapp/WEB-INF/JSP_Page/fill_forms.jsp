...
<body class="background-image-body background1 square scrollbar-dusty-grass square thin">
    ...
    <div class="wrapper wrapper-top">
        <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-sm-6 col-xs-12 colmspadding">
                                            <div class="form-group mb-0">
                                                ...
                                                <select id="formList" class="selectpicker" data-style="lineheight12 bg-transfer"
                                                    data-live-search="true" data-title="Select Form">
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-sm-6 col-xs-12 mb-0 btntop colmspadding">
                                            <div class="form-group mb-0">
                                                <a onclick="fillForm()" class="save_form_details btn btn-success text-white btn-padding"
                                                    id="searchbtn"><i class="fa fa-search mr-2"></i>Go</a>
                                                <a onclick="resetBtn()" id="resetBtn" style="display: none;"
            ...
            <div id="fillFormModel" class="row showformfill" style="display: none;">
                <div class="col-xl-12 col-lg-12 col-sm-12 colmspadding">
                    <div class="card">
                        ...
                        <div class="card-body" style="background-color: #F3F3F3;">
                            <div class="row">
                                <div id="form_fill_body" class="col-xl-12 col-lg-12 col-sm-12">
    ...
    <script src="/JS_Page/fill_form_js.js"></script>
