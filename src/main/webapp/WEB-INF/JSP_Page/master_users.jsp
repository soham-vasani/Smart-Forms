                                    ...
                                    <div class="row">                        
                                        ...
                                        <div class="col-xl-2 col-lg-2 col-sm-4 col-xs-12 colmspadding">
                                            <div class="form-group mb-0">
                                                ...
                                                <select id="userRole" class="selectpicker" data-style="lineheight12 bg-transfer" data-live-search="true">
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-sm-3 col-xs-12 mb-0 btntop colmspadding">
                                            <div class="form-group mb-0">
                                            <a onclick="searchByFilter()" class="save_form_details btn btn-success text-white btn-padding" id="searchbtn"><i class="fa fa-search mr-2"></i>Search</a>
                                                
                                            <a onclick="resetsearchByFilter()" class="show-details-table btn btn-danger text-white btn-padding ml-1"><i class="fa fa-refresh mr-2"></i>Reset</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-4">
                                    <a onclick="addUserBtn()" href="javascript:void(0)" class="btn btn-warning waves-effect float-right btn-padding client_add_btn"><i class="fa fa-plus"></i> Add Users</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body pl-2 pr-2 pb-0 pt-0">
                        <div class="row pl-2 pr-2">
                            <div class="col-xl-2 col-lg-3 col-sm-4 col-xs-12 colmspadding text-center">
                                <div><img src="assets/images/users/default_user.png" class="mt-2 userimg" width="155" height="155"></div>
                                ...
                                <div class="btn btn-success text-white btn-padding mt-2" style="position: relative; overflow: hidden;">
                                    ...
                                    <input id="userImg" type="file" onchange="displayImg(this)" name="file" accept="image/*" style="opacity: 0; right: 0; position: absolute;">
                                </div>

                                <div onclick="removeImg()" class="btn btn-success text-white btn-padding mt-2 ml-1">
                                ...
                                <div class="row pl-2 pr-2 pt-1">
                                    <div class="col-xl-3 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <input id="fName" oninput="inputChar(this)" maxlength="15" type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <input id="lName" oninput="inputChar(this)" maxlength="15" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row pl-2 pr-2">
                                    ...
                                    <div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <input id="contactNo" oninput="validateContact(this)" type="text" onKeyPress="if(this.value.length==10) return false;" class="form-control text-right">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <select id="gender" class="selectpicker" data-style="lineheight12 bg-transfer" data-live-search="true">
                                                <option value="" selected="selected">Select</option>
                                        ...
                                        <div class="row pl-2 pr-2">
                                            <div class="col-xl-6 col-lg-6 col-sm-6 colmspadding">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control validFrom" placeholder="dd/mm/yyyy" id="valid_from">
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-sm-6 colmspadding">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control validTo" placeholder="dd/mm/yyyy" id="valid_to">
                                                        <span class="input-group-addon inputgroups">
                                                            <i class="mdi mdi-calendar"></i>
                                                        </span>
                                                    </div>
                        ...
                        <div class="text-center border-top mt-1 pt-2 mb-2">
                            <a id="" name="saveUser" onclick="saveUserBtn()" class="btn btn-success text-white btn-padding"><i class="fa fa-floppy-o mr-2"></i>Save</a>
...
<script src="JS_Page/master_users_js.js"></script>
