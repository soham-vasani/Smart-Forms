...
function saveQueBtn(){
    ...
    let ans_Type_Id = Number($("#ansType :selected").attr('id'));
                ...
                if(saveQueBtnId == 0){
                    ...
                    queList.forEach((eachQue)=>{
                        if(eachQue.queId == saveQueBtnId){
                            ...
                            eachQue.createdBy = 1;
                            eachQue.createdOn = "2001-01-01";
                            eachQue.modifyBy = 1;
                            eachQue.modifyOn = "2001-01-01";
            ...
            if(eachQue.ansTypeId == 1){
                ...
                optionList.forEach((eachOption)=>{
                    ...
                    if(eachOption.queId == queId){                                                
                        addSingleChoice(eachOption.optionsValue);
                    }
                ...
                optionList.forEach((eachOption)=>{
                    ...
                    if(eachOption.queId == queId){                                                
                        addMultiChoice(eachOption.optionsValue);
                    }
                ...
                optionList.forEach((eachOption)=>{
                    ...
                    if(eachOption.queId == queId){                                                
                        addSingleSelect(eachOption.optionsValue);
                    }
        ...
        buttons: {
            delete: {
                ...
                action: function() {
                    ...
                    const api = `http://localhost:9090/deleteQueAndOpt/${queId}`;
...
function editForm(formId){
    ...
    .then(async formData=>{
        ...
        $("#active").prop("selected",Boolean(formData.formData.activeId));
    ...
    .then(formData=>{        
        ...
        for(let i=0; i<formData.queData.length; i++){
            ...
            switch(formData.queData[i].ansTypeId){
                ...
                console.log(queDetails6_1+queDetails6_2+queDetails6_3);
...
//remove all the quetion value and field and append single field clear text field(for clear user input).
...
//add for fill the field while edit quetion.(work when edit btn click);
function addSingleChoice(optionsValue){
    ...
    $("#singleChoice tbody").append(`
                                <tr>
                                    ...
                                    <td class="border-0 p-1">
                                        <div class="form-group mb-0">
                                            <input value="${optionsValue}" type="text" class="form-control"
                                                placeholder="Enter an answer choice in English">
                                        </div>
                                    </td>
...
function addMultiChoice(optionsValue){
    ...
    <tr>
        ...
        <td class="border-0 p-1">
            <div class="form-group mb-0">
                <input type="text" value="${optionsValue}" class="form-control"
                    placeholder="Enter an answer choice in English">
            </div>
        </td>
...
function addSingleSelect(optionsValue){
...
function addMultiSelect(optionsValue){
    ...
    <tr>
        ...
        <td class="border-0 p-1">
            <div class="form-group mb-0">
                <input type="text" class="form-control" value = "${optionsValue}"
                    placeholder="Enter an answer choice in English">
            </div>
        </td>
