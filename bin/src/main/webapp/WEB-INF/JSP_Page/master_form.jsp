                                        ...
                                        <div class="row pl-3 pr-3">
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-sm-3 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <input id="aliasName" type="text" class="form-control">
                                                </div>
                                            </div>
                                ...
                                <table class="table table-striped nowrap mb-0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    <input id="queLabel" type="text" class="form-control"
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    <input id="queName" type="text" class="form-control"
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0"><textarea id="queDescription" class="form-control textareasize"
